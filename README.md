...
```
Open **Command**, switch **Dispatch engine → OmniMesh AI**, use the header **Connectivity** toggle to flip offline/online routing live. The fired mode (`LOCAL` / `CLOUD` / `HYBRID`) renders as a badge — this is the judging centerpiece.
